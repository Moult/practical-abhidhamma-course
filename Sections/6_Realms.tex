...
\cmidrule{2-4}
\textit{21}--\textit{27} & \multicolumn{2}{c}{Fine Material Plane} & Brahma (5\textsuperscript{th} jhāna)\\
...
\cmidrule{2-4}
\textit{6}--\textit{11} & \multirow{3} {0.2\textwidth} {Sensuous Plane} & \multirow{2} {0.23\textwidth} {Happy Destinations} & \textit{Deva}\\
\textit{5} & & & Human\\
\cmidrule{3-4}
